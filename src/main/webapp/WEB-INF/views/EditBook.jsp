				...
				<form action="Edit" method="post">
					<div class="mb-3 row">
						<label for="BookCode" class="col-2 mx-4">Book Code</label> <input
							...
							value="${book.getId()}" name="bookcode" readonly>

					</div>
					<div class="mb-3 row">
						<label for="BookName" class="col-2 mx-4">Book Name</label> <input
							type="text" class="col-4" id="bookName"
							value="${book.getName()}" name="bookName" required>

					</div>
					<div class="mb-3 row">
						<label for="Author" class="col-2 mx-4">Author</label> 
						
						<select class="col-4" name="author" id="author" required>
					...
					<div class="mb-3 row">
						<label for="AddedOn" class="col-2 mx-4">Added On</label> <input
							...
							value="${book.getDate()}" name="addedOn" readonly>
					...
					<div class="col-12 mx-4">
						...
						<button type="submit" class="btn btn-outline-danger"><a href="/">CANCEL</a></button>
