package com.advancejava.services;
...
public class BookService {
    ...
    public List<Book> retrieveBooks() {
        ...
        try {
            URL url = new URL("http://localhost:8084/api/books");
    ...
    public void deleteBook(int bookcode) {
        ...
        try {
            URL url = new URL("http://localhost:8084/api/books/"+bookcode);
            HttpURLConnection conn = (HttpURLConnection) url.openConnection();
    ...
    public void saveBook(Book book,String method) {
        ...
        String query_url = "http://localhost:8084/api/books";
        ObjectMapper objectMapper = new ObjectMapper();
        try {
